...
document.addEventListener('DOMContentLoaded',  () => {
    ...
    const storedClasses = JSON.parse(localStorage.getItem('uClasses'));

    storedClasses.forEach(newclass => {
        const newfilterChoice = document.createElement('div');
        newfilterChoice.className = "filter-choice";
        newfilterChoice.innerHTML = ` <input type="checkbox" class="filter-check" value="${newclass.name}"> ${newclass.name}`;
